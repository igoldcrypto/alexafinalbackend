...
//       createdAt: {
//         $gte: moment().subtract(20, "minutes").toDate(),
//         $lt: moment().toDate(),
//       },
//     }).lean(),
...
//   //   console.log("below in the invoices   =================>   ")
...
//             if (
//               leftBusiness >= Number(Package_Price) &&
//               rightBusiness >= Number(Package_Price)
//             ) {
//               var combo = 0;
...
exports.NewMatchingBonus = async (req, res) => {
  ...
  const [
    ...
    PurchasePackageInvoice.find({
      createdAt: {
        $gte: moment().subtract(59, "minutes").toDate(),
        $lt: moment().toDate(),
      },
    }).lean(),
    ShortRecord.find().lean(),
